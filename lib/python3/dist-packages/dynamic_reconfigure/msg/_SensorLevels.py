...
"""autogenerated by genpy from dynamic_reconfigure/SensorLevels.msg. Do not edit."""
import codecs
import sys
...
class SensorLevels(genpy.Message):
  _md5sum = "6322637bee96d5489db6e2127c47602c"
  _type = "dynamic_reconfigure/SensorLevels"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# This message is deprecated, please use driver_base/SensorLevels instead.
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SensorLevels, self).__init__(*args, **kwds)
