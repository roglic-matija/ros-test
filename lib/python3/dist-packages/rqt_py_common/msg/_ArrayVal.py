...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.vals is None:
        self.vals = [rqt_py_common.msg.Val() for _ in range(5)]
    else:
      self.vals = [rqt_py_common.msg.Val() for _ in range(5)]
  ...
  def serialize(self, buff):
    ...
    try:
      if len(self.vals) != 5:
        self._check_types(ValueError("Expecting %s items but found %s when writing '%s'" % (5, len(self.vals), 'self.vals')))
      for val1 in self.vals:
        buff.write(_get_struct_5d().pack(*val1.floats))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, 5):
        ...
        val1.floats = _get_struct_5d().unpack(str[start:end])
