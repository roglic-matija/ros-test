...
"""autogenerated by genpy from std_msgs/Int8MultiArray.msg. Do not edit."""
import codecs
import sys
...
class Int8MultiArray(genpy.Message):
...
uint32 stride  # stride of given dimension"""
  ...
  _slot_types = ['std_msgs/MultiArrayLayout','int8[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Int8MultiArray, self).__init__(*args, **kwds)
