...
"""autogenerated by genpy from actionlib/TestRequestActionResult.msg. Do not edit."""
import codecs
import sys
...
class TestRequestActionResult(genpy.Message):
  _md5sum = "0476d1fdf437a3a6e7d6d0e9f5561298"
  _type = "actionlib/TestRequestActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','actionlib/TestRequestResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TestRequestActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = actionlib.msg.TestRequestResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = actionlib.msg.TestRequestResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_iB().pack(_x.result.the_result, _x.result.is_simple_server))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.the_result, _x.result.is_simple_server,) = _get_struct_iB().unpack(str[start:end])
      self.result.is_simple_server = bool(self.result.is_simple_server)
      return self
