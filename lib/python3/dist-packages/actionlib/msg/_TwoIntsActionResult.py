...
"""autogenerated by genpy from actionlib/TwoIntsActionResult.msg. Do not edit."""
import codecs
import sys
...
class TwoIntsActionResult(genpy.Message):
  _md5sum = "3ba7dea8b8cddcae4528ade4ef74b6e7"
  _type = "actionlib/TwoIntsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','actionlib/TwoIntsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TwoIntsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = actionlib.msg.TwoIntsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = actionlib.msg.TwoIntsResult()
