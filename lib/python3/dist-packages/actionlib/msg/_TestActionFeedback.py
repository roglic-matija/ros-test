...
"""autogenerated by genpy from actionlib/TestActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TestActionFeedback(genpy.Message):
  _md5sum = "6d3d0bf7fb3dda24779c010a9f3eb7cb"
  _type = "actionlib/TestActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','actionlib/TestFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TestActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = actionlib.msg.TestFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = actionlib.msg.TestFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.feedback,) = _get_struct_i().unpack(str[start:end])
      return self
