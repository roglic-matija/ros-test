...
"""autogenerated by genpy from actionlib/TestActionGoal.msg. Do not edit."""
import codecs
import sys
...
class TestActionGoal(genpy.Message):
  _md5sum = "348369c5b403676156094e8c159720bf"
  _type = "actionlib/TestActionGoal"
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = actionlib.msg.TestGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = actionlib.msg.TestGoal()
