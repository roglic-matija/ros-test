...
"""autogenerated by genpy from actionlib/TwoIntsActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TwoIntsActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "actionlib/TwoIntsActionFeedback"
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = actionlib.msg.TwoIntsFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = actionlib.msg.TwoIntsFeedback()
