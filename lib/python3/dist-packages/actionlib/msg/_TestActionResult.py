...
"""autogenerated by genpy from actionlib/TestActionResult.msg. Do not edit."""
import codecs
import sys
...
class TestActionResult(genpy.Message):
  _md5sum = "3d669e3a63aa986c667ea7b0f46ce85e"
  _type = "actionlib/TestActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','actionlib/TestResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TestActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = actionlib.msg.TestResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = actionlib.msg.TestResult()
