...
"""autogenerated by genpy from actionlib/TestRequestActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TestRequestActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "actionlib/TestRequestActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','actionlib/TestRequestFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TestRequestActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = actionlib.msg.TestRequestFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = actionlib.msg.TestRequestFeedback()
