...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_iB().pack(_x.goal.terminate_status, _x.goal.ignore_cancel))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_iB6i().pack(_x.goal.the_result, _x.goal.is_simple_client, _x.goal.delay_accept.secs, _x.goal.delay_accept.nsecs, _x.goal.delay_terminate.secs, _x.goal.delay_terminate.nsecs, _x.goal.pause_status.secs, _x.goal.pause_status.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.terminate_status, _x.goal.ignore_cancel,) = _get_struct_iB().unpack(str[start:end])
      ...
      if python3:
        self.goal.result_text = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.result_text = str[start:end]
      _x = self
      start = end
      end += 29
      (_x.goal.the_result, _x.goal.is_simple_client, _x.goal.delay_accept.secs, _x.goal.delay_accept.nsecs, _x.goal.delay_terminate.secs, _x.goal.delay_terminate.nsecs, _x.goal.pause_status.secs, _x.goal.pause_status.nsecs,) = _get_struct_iB6i().unpack(str[start:end])
