...
bool operator==(const ::dynamic_reconfigure::ConfigDescription_<ContainerAllocator1> & lhs, const ::dynamic_reconfigure::ConfigDescription_<ContainerAllocator2> & rhs)
{
