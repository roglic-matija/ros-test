...
bool operator==(const ::dynamic_reconfigure::ReconfigureResponse_<ContainerAllocator1> & lhs, const ::dynamic_reconfigure::ReconfigureResponse_<ContainerAllocator2> & rhs)
{
