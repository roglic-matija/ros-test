...
bool operator==(const ::dynamic_reconfigure::ReconfigureRequest_<ContainerAllocator1> & lhs, const ::dynamic_reconfigure::ReconfigureRequest_<ContainerAllocator2> & rhs)
{
